...
enum $0
	...
	mainColor db #63
	colorToggle db 0
	include "includes/64cube_ft5.inc"	; FamiTone5 uses 36 bytes of zeropage.
ende
...
framebuf equ #$1000
	...
	; Load song data
	ldx #<ft5testsong_music_data
	ldy #>ft5testsong_music_data
	lda #1 ; 1 ntsc, 0 pal
...
; FamiTone Settings
	...
	include "ft2-demo/ft5testsong.asm"	; our beautiful song
	include "ft2-demo/ft5testsfx.asm"	; our lovely sound effects
