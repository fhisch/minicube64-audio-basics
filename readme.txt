...
This is a demo of using the FamiTone audio library with the Minicube64 fantasy console emulator.
...
Music and SFX each need to be contained in their own separate files. When using the following conversion tools, always be sure to use the -asm6 flag.
...
Converts a song exported as .txt to .asm. If you are using any DPCM samples, the tool will create an additional file
...
ft2-demo/mc64_ft2audio_demo.s   - Contains both music and sound effects.
ft2-demo/mc64_ft2basic_music.s  - A bare minimum of code to have music playing.
ft2-demo/ft2testsong.asm        - Music created with FamiTracker and converted using text2data.exe
ft2-demo/ft2testsfx.asm         - Sound effects created with FamiTracker and converted using nsf2data.exe

:: FamiTone5

ft2-demo/mc64_ft2audio_demo.s   - Contains both music and sound effects.
ft2-demo/mc64_ft2basic_music.s  - A bare minimum of code to have music playing.
ft2-demo/ft2testsong.asm        - Music created with FamiTracker and converted using text2vol5.exe
ft2-demo/ft2testsfx.asm         - Sound effects created with FamiTracker and converted using nsf2data5.exe
...
FamiTone was originally written by Shiru 04'17. Versions 2d and 5 are unofficial updates by Doug Fraker (nesdoug.com).
